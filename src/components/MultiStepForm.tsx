        ...
        {step < totalSteps ? (
          ...
          <div className="flex flex-col items-end gap-2">
            <button
              ...
              className={`btn-primary !text-sm ${!canAdvance() || loading ? "opacity-30 pointer-events-none" : ""}`}
            >
              {loading ? (
                ...
                <span className="flex items-center gap-2">Submit Request <Check size={14} /></span>
              )}
            </button>
            {submitError && (
